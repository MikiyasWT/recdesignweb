...
const Navbar = () => {
    ...
    const token = localStorage.getItem('authCookies'); // Replace with your token storage mechanism
...
<nav class="bg-white border-gray-200 dark:bg-gray-900 w-full mb-4">
    <div class="w-full flex flex-wrap justify-between items-center mx-auto  p-4 ">
        ...
        <div class="flex items-center space-x-6 rtl:space-x-reverse">
            <a href="tel:5541251234" class="text-sm  text-gray-500 dark:text-white hover:underline">{role}</a>
    ...
    <div class="w-full flex flex-wrap justify-end items-center mx-auto  p-4 bg-gray-300">
       <button onClick={openAddingModal} type="button" class="text-white flex flex-row justify- bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Run Scrapping</button>
